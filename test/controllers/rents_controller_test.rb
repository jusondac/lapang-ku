...
class RentsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create rent" do
    assert_difference("Rent.count") do
      post rents_url, params: { rent: { field_id: @rent.field_id, rent_detail_id: @rent.rent_detail_id } }
    end
  ...
  test "should update rent" do
    patch rent_url(@rent), params: { rent: { field_id: @rent.field_id, rent_detail_id: @rent.rent_detail_id } }

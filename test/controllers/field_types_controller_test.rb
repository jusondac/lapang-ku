...
class FieldTypesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create field_type" do
    assert_difference("FieldType.count") do
      post field_types_url, params: { field_type: { name: @field_type.name, price: @field_type.price } }
    end
  ...
  test "should update field_type" do
    patch field_type_url(@field_type), params: { field_type: { name: @field_type.name, price: @field_type.price } }
